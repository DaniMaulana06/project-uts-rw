...
<div class="carousel-item active">
    <img src="{{ asset('storage/banner/banner1.jpeg') }}" 
...
<div class="carousel-item">
    <img src="{{ asset('storage/banner/hd.jpg') }}" 
         class="d-block w-100 hero-img"
...
{{-- Slide 3 --}}
<div class="carousel-item">
    <img src="{{ asset('storage/banner/hd2.jpg') }}" 
         class="d-block w-100 hero-img"
    ...
    <div class="container py-5">
        ...
        <div class="text-center mt-5"
            style="max-width: 700px; margin-left:auto; margin-right:auto; color: #333; font-family: 'Poppins', sans-serif;">
            ...
            <h2
                style="font-family: 'Dancing Script', cursive; font-weight: 400; font-size: 36px; margin-top: 10px; margin-bottom: 20px; color: #1b2b22;">
                Keunggulan Toko Bunga Kami
            </h2>

            <p style="font-weight: 300; font-size: 16px; line-height: 1.7; color: #555;">
                Percayakan kebutuhan bunga Anda kepada blossom_avenue - toko bunga terpercaya yang selalu memberikan
                kualitas bunga terbaik dan pelayanan yang profesional. Kami telah terbukti sebagai toko bunga terpercaya
                dengan kepercayaan dari ribuan pelanggan yang telah menggunakan jasa kami.
            </p>
        </div>
    </div>
        ...
        <div id="testimonial-cards" style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: center;">
            ...
            <div class="testimonial-card" tabindex="0">
                <p style="font-style: normal;">
                    ...
                    Toko bunga blossom_avenue sangat terpercaya dan profesional. Saya telah memesan bunga untuk grand
                    opening perusahaan saya di Sudirman dan rangkaian bunga yang disediakan oleh blossom_avenue sungguh
                    memukau. Saya akan merekomendasikan blossom_avenue kepada teman-teman dan kolega saya.
                </p>
            ...
            <div class="testimonial-card" tabindex="0">
                <p style="font-style: normal;">
                    <span style="color: #ff7ab8; font-size: 28px; vertical-align: top;">&#8220;</span>
                    Saya sangat puas dengan pelayanan toko bunga blossom_avenue. Bunga yang saya pesan untuk acara
                    pernikahan saya di Whyndam sangat cantik dan segar. Terima kasih blossom_avenue!
                </p>
            ...
            <div class="testimonial-card" tabindex="0">
                <p style="font-style: normal;">
                    <span style="color: #ff7ab8; font-size: 28px; vertical-align: top;">&#8220;</span>
                    Saya sangat terkesan dengan bunga yang saya pesan dari toko bunga bloosom_avenue. Saya memesan bunga box
                    untuk mengucapkan selamat pelantikan CPNS kepada saudara saya dan bunga yang diterima sangat indah dan
                    menyentuh hati.
                </p>
        ...
        <div style="margin-top: 40px; max-width: 500px; margin-left: auto; margin-right: auto;">
            ...
            <form id="testimonial-form" style="display: flex; flex-direction: column; gap: 15px;">
                <textarea id="comment" placeholder="Tulis komentar Anda..." required
                    style="width: 100%; min-height: 80px; padding: 10px; font-family: inherit; font-size: 14px; border: 1px solid #ccc; border-radius: 6px;"></textarea>
                <input type="text" id="name" placeholder="Nama Anda" required
                    style="padding: 10px; font-family: inherit; font-size: 14px; border: 1px solid #ccc; border-radius: 6px;">
                <input type="text" id="location" placeholder="Kota/Daerah" required
                    style="padding: 10px; font-family: inherit; font-size: 14px; border: 1px solid #ccc; border-radius: 6px;">
                <button type="submit"
                    style="background-color: #ff7ab8; color: white; font-weight: 600; padding: 12px; border: none; border-radius: 6px; cursor: pointer; transition: background-color 0.3s;">
                    Kirim Testimoni
                </button>
            </form>
        </div>
