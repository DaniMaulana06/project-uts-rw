...
@section('body')
  ...
  <style>
    .hero-img{ height: 420px; object-fit: cover; }
    .btn-pink{ background:#ff7ab8;border-color:#ff7ab8;color:#fff; }
    .btn-pink:hover{ background:#ff539e;border-color:#ff539e;color:#fff; }
    .btn-outline-pink{ color:#ff7ab8;border-color:#ff7ab8; }
    .btn-outline-pink:hover{ background:#ff7ab8;color:#fff; }
    .carousel-caption{ text-shadow: 0 2px 16px rgba(0,0,0,.45); }
  </style>
@endsection
